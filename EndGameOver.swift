...
class EndGameScene:SKScene {
    ...
    init(size: CGSize, runDistance: Int){
        ...
        lblHighRunDistance.text = String(format: "Record %d", GameState.sharedInstance.highRunDistance)
        ...
        lblTapAgain.text = "Press to play again!"
